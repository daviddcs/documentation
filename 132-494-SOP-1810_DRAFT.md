...
#### 4.14 Radio Procedures
4.14.1. All directives that require a response are to be executed when the last flight member acknowledges the directive. For example with a 2-ship: "Lead Fury 1 tac left" Take note that there is no “action” call. As stated above, the action is initiated immediately after the last wingman responds.
